...
public class TrackFixtures {
    ...
    private static TrackFixtureFactory buildTrackFixtureFactory(String artistURL,Optional<String> optAlbumURL, String trackURL, String title,int duration) {
      ...
      return TrackFixtureFactory.builder()
      .dry( () -> 
          Track.builder()
          .origin(trackURL)
  ...
  public static final class FEMTANYL {
    ...
    public static final class REACTOR{
      ...
      public static final TrackFixtureFactory ITS_TIME_2_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), ITS_TIME_2_URL, ITS_TIME_2_TITLE, ITS_TIME_2_DURATION);
      ...
      public static final TrackFixtureFactory WEIGHTLESS_2_FF = 
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), WEIGHTLESS_2_URL, WEIGHTLESS_2_TITLE, WEIGHTLESS_2_DURATION);
      ...
      public static final TrackFixtureFactory DINNER_2_FF = 
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), DINNER_2_URL, DINNER_2_TITLE, DINNER_2_DURATION);
      ...
      public static final TrackFixtureFactory M3_N_MIN3_FEAT_DANNY_BROWN_2_FF = 
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), M3_N_MIN3_FEAT_DANNY_BROWN_2_URL, M3_N_MIN3_FEAT_DANNY_BROWN_2_TITLE, M3_N_MIN3_FEAT_DANNY_BROWN_2_DURATION);
      ...
      public static final TrackFixtureFactory ATTACKING_VERTICAL_2_FF = 
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), ATTACKING_VERTICAL_2_URL, ATTACKING_VERTICAL_2_TITLE, ATTACKING_VERTICAL_2_DURATION);
      ...
      public static final TrackFixtureFactory AND_IM_GONE_2_FF = 
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), AND_IM_GONE_2_URL, AND_IM_GONE_2_TITLE, AND_IM_GONE_2_DURATION);
    ...
    public static class CHASER {
      ...
      public static final TrackFixtureFactory ACT_RIGHT_3_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), ACT_RIGHT_3_URL, ACT_RIGHT_3_TITLE, ACT_RIGHT_3_DURATION);
      ...
      public static final TrackFixtureFactory P3T_2_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), P3T_2_URL, P3T_2_TITLE, P3T_2_DURATION);
      ...
      public static final TrackFixtureFactory PUSH_UR_T3MPRR_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), PUSH_UR_T3MPRR_URL, PUSH_UR_T3MPRR_TITLE, PUSH_UR_T3MPRR_DURATION);
      ...
      public static final TrackFixtureFactory KATAMARI_2_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), KATAMARI_2_URL, KATAMARI_2_TITLE, KATAMARI_2_DURATION);
      ...
      public static final TrackFixtureFactory MURDER_EVERY_1_U_KNOW_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), MURDER_EVERY_1_U_KNOW_URL, MURDER_EVERY_1_U_KNOW_TITLE, MURDER_EVERY_1_U_KNOW_DURATION);
      ...
      public static final TrackFixtureFactory GIRL_HELL_1999_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.of(ALBUM_URL), GIRL_HELL_1999_URL, GIRL_HELL_1999_TITLE, GIRL_HELL_1999_DURATION);
    }
    ...
    public static class SINGLES {
      ...
      public static final TrackFixtureFactory LOTTERY_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.empty(), LOTTERY_URL, LOTTERY_TITLE, LOTTERY_DURATION);
      ...
      public static final TrackFixtureFactory WEIGHTLESS_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.empty(), WEIGHTLESS_URL, WEIGHTLESS_TITLE, WEIGHTLESS_DURATION);
      ...
      public static final TrackFixtureFactory ATTACKING_VERTICAL_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.empty(), ATTACKING_VERTICAL_URL, ATTACKING_VERTICAL_TITLE, ATTACKING_VERTICAL_DURATION);
      ...
      public static final TrackFixtureFactory ITS_TIME_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.empty(), ITS_TIME_URL, ITS_TIME_TITLE, ITS_TIME_DURATION);
      ...
      public static final TrackFixtureFactory M3_N_MIN3_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.empty(), M3_N_MIN3_URL, M3_N_MIN3_TITLE, M3_N_MIN3_DURATION);
      ...
      public static final TrackFixtureFactory DINNER_BANG_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.empty(), DINNER_BANG_URL, DINNER_BANG_TITLE, DINNER_BANG_DURATION);
      ...
      public static final TrackFixtureFactory LOVESICK_COMMA_CANNIBAL_BANG_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.empty(), LOVESICK_COMMA_CANNIBAL_BANG_URL, LOVESICK_COMMA_CANNIBAL_BANG_TITLE, LOVESICK_COMMA_CANNIBAL_BANG_DURATION);
      ...
      public static final TrackFixtureFactory DOGMATICA_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.empty(), DOGMATICA_URL, DOGMATICA_TITLE, DOGMATICA_DURATION);
      ...
      public static final int GIRL_HELL_1999_DURATION = 145;
      public static final TrackFixtureFactory GIRL_HELL_1999_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.empty(), GIRL_HELL_1999_URL, GIRL_HELL_1999_TITLE, GIRL_HELL_1999_DURATION);
      ...
      public static final TrackFixtureFactory KATAMARI_FF =
        buildTrackFixtureFactory(ARTIST_URL, Optional.empty(), KATAMARI_URL, KATAMARI_TITLE, KATAMARI_DURATION);
